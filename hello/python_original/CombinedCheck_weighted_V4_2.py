## !!! all .json files should be in same directory
## as this file for this Python file to run
...
AL_D_json=open('AL_D.json').read()
AL_R_json=open('AL_R.json').read()
AR_D_json=open('AR_D.json').read()
AR_R_json=open('AR_R.json').read()
AZ_D_json=open('AZ_D.json').read()
AZ_R_json=open('AZ_R.json').read()
CA_D_json=open('CA_D.json').read()
CA_R_json=open('CA_R.json').read()
CT_D_json=open('CT_D.json').read()
CT_R_json=open('CT_R.json').read()
FL_D_json=open('FL_D.json').read()
FL_R_json=open('FL_R.json').read()
GA_D_json=open('GA_D.json').read()
GA_R_json=open('GA_R.json').read()
IA_D_json=open('IA_D.json').read()
IA_R_json=open('IA_R.json').read()
IL_D_json=open('IL_D.json').read()
IL_R_json=open('IL_R.json').read()
IN_D_json=open('IN_D.json').read()
IN_R_json=open('IN_R.json').read()
KS_R_json=open('KS_R.json').read()
LA_D_json=open('LA_D.json').read()
LA_R_json=open('LA_R.json').read()
MA_D_json=open('MA_D.json').read()
MA_R_json=open('MA_R.json').read()
MD_D_json=open('MD_D.json').read()
MD_R_json=open('MD_R.json').read()
MI_D_json=open('MI_D.json').read()
MI_R_json=open('MI_R.json').read()
MO_D_json=open('MO_D.json').read()
MO_R_json=open('MO_R.json').read()
MS_D_json=open('MS_D.json').read()
NC_D_json=open('NC_D.json').read()
NC_R_json=open('NC_R.json').read()
NH_D_json=open('NH_D.json').read()
NH_R_json=open('NH_R.json').read()
NJ_D_json=open('NJ_D.json').read()
NJ_R_json=open('NJ_R.json').read()
NV_D_json=open('NV_D.json').read()
NV_R_json=open('NV_R.json').read()
NY_D_json=open('NY_D.json').read()
NY_R_json=open('NY_R.json').read()
OH_D_json=open('OH_D.json').read()
OH_R_json=open('OH_R.json').read()
OK_D_json=open('OK_D.json').read()
OK_R_json=open('OK_R.json').read()
PA_D_json=open('PA_D.json').read()
PA_R_json=open('PA_R.json').read()
RI_D_json=open('RI_D.json').read()
RI_R_json=open('RI_R.json').read()
SC_D_json=open('SC_D.json').read()
SC_R_json=open('SC_R.json').read()
TN_D_json=open('TN_D.json').read()
TN_R_json=open('TN_R.json').read()
TX_D_json=open('TX_D.json').read()
TX_R_json=open('TX_R.json').read()
UT_D_json=open('UT_D.json').read()
UT_R_json=open('UT_R.json').read()
VA_D_json=open('VA_D.json').read()
VA_R_json=open('VA_R.json').read()
VT_D_json=open('VT_D.json').read()
WI_D_json=open('WI_D.json').read()
WI_R_json=open('WI_R.json').read()
WV_D_json=open('WV_D.json').read()
WV_R_json=open('WV_R.json').read()
...
IA_Rp_json=open('table_1533.json').read()
NH_Rp_json=open('table_1534.json').read()
SC_Rp_json=open('table_1553.json').read()
NV_Rp_json=open('table_1554.json').read()
AL_Rp_json=open('table_1571.json').read()
AK_Rp_json=open('table_1572.json').read()
GA_Rp_json=open('table_1575.json').read()
AR_Rp_json=open('table_1573.json').read()
MA_Rp_json=open('table_1576.json').read()
MN_Rp_json=open('table_1577.json').read()
OK_Rp_json=open('table_1578.json').read()
TN_Rp_json=open('table_1579.json').read()
TX_Rp_json=open('table_1580.json').read()
VA_Rp_json=open('table_1582.json').read()
KS_Rp_json=open('table_1642.json').read()
KY_Rp_json=open('table_1638.json').read()
LA_Rp_json=open('table_1639.json').read()
ME_Rp_json=open('table_1640.json').read()
PR_Rp_json=open('table_1641.json').read()
HI_Rp_json=open('table_1650.json').read()
ID_Rp_json=open('table_1651.json').read()
MI_Rp_json=open('table_1652.json').read()
MS_Rp_json=open('table_1653.json').read()
DC_Rp_json=open('table_1670.json').read()
FL_Rp_json=open('table_1661.json').read()
IL_Rp_json=open('table_1660.json').read()
MO_Rp_json=open('table_1662.json').read()
NC_Rp_json=open('table_1663.json').read()
OH_Rp_json=open('table_1659.json').read()
AZ_Rp_json=open('table_1672.json').read()
UT_Rp_json=open('table_1673.json').read()


IA_Dp_json=open('table_1541.json').read()
NH_Dp_json=open('table_1540.json').read()
NV_Dp_json=open('table_1606.json').read()
SC_Dp_json=open('table_1607.json').read()
AL_Dp_json=open('table_1614.json').read()
AR_Dp_json=open('table_1615.json').read()
CO_Dp_json=open('table_1616.json').read()
GA_Dp_json=open('table_1617.json').read()
MA_Dp_json=open('table_1618.json').read()
MN_Dp_json=open('table_1619.json').read()
OK_Dp_json=open('table_1620.json').read()
TN_Dp_json=open('table_1621.json').read()
TX_Dp_json=open('table_1622.json').read()
VT_Dp_json=open('table_1623.json').read()
VA_Dp_json=open('table_1624.json').read()
KS_Dp_json=open('table_1643.json').read()
LA_Dp_json=open('table_1644.json').read()
NE_Dp_json=open('table_1645.json').read()
ME_Dp_json=open('table_1646.json').read()
MI_Dp_json=open('table_1649.json').read()
MS_Dp_json=open('table_1648.json').read()
FL_Dp_json=open('table_1654.json').read()
IL_Dp_json=open('table_1655.json').read()
MO_Dp_json=open('table_1656.json').read()
NC_Dp_json=open('table_1657.json').read()
OH_Dp_json=open('table_1658.json').read()
AZ_Dp_json=open('table_1679.json').read()
UT_Dp_json=open('table_1678.json').read()
ID_Dp_json=open('table_1681.json').read()
AK_Dp_json=open('table_1686.json').read()
HI_Dp_json=open('table_1687.json').read()
WA_Dp_json=open('table_1688.json').read()
WI_Rp_json=open('table_1703.json').read()
WI_Dp_json=open('table_1695.json').read()
WY_Dp_json=open('table_1696.json').read()
NY_Rp_json=open('table_1704.json').read()
NY_Dp_json=open('table_1697.json').read()




CT_Rp_json=open('table_1705.json').read()
DE_Rp_json=open('table_1706.json').read()
MD_Rp_json=open('table_1707.json').read()
PA_Rp_json=open('table_1708.json').read()
RI_Rp_json=open('table_1709.json').read()
CT_Dp_json=open('table_1698.json').read()
DE_Dp_json=open('table_1699.json').read()
MD_Dp_json=open('table_1700.json').read()
PA_Dp_json=open('table_1701.json').read()
RI_Dp_json=open('table_1702.json').read()
IN_Rp_json=open('table_1721.json').read()
NE_Rp_json=open('table_1722.json').read()
WV_Rp_json=open('table_1723.json').read()
IN_Dp_json=open('table_1726.json').read()
WV_Dp_json=open('table_1727.json').read()
KY_Dp_json=open('table_1728.json').read()
OR_Dp_json=open('table_1729.json').read()
OR_Rp_json=open('table_1724.json').read()
WA_Rp_json=open('table_1725.json').read()
CA_Rp_json=open('table_1741.json').read()
MT_Rp_json=open('table_1742.json').read()
NJ_Rp_json=open('table_1743.json').read()
NM_Rp_json=open('table_1744.json').read()
SD_Rp_json=open('table_1745.json').read()
CA_Dp_json=open('table_1746.json').read()
MT_Dp_json=open('table_1751.json').read()
NJ_Dp_json=open('table_1749.json').read()
NM_Dp_json=open('table_1752.json').read()
ND_Dp_json=open('table_1750.json').read()
SD_Dp_json=open('table_1748.json').read()
DC_Dp_json=open('table_1753.json').read()
...
##Winners['Alabama']=('Hillary Clinton','Donald Trump')
##Winners['Alaska']=('Bernie Sanders','Ted Cruz')
##Winners['Arkansas']=('Hillary Clinton','Donald Trump')
##Winners['Arizona']=('Hillary Clinton','Donald Trump')
##Winners['California']=('Hillary Clinton','Donald Trump')
##Winners['Colorado']=('Bernie Sanders','NA')
##Winners['Connecticut']=('Hillary Clinton','Donald Trump')
##Winners['Delaware']=('Hillary Clinton','Donald Trump')
##Winners['Florida']=('Hillary Clinton','Donald Trump')
##Winners['Georgia']=('Hillary Clinton','Donald Trump')
##Winners['Hawaii']=('Bernie Sanders','Donald Trump')
##Winners['Idaho']=('Bernie Sanders','Ted Cruz')
##Winners['Iowa']=('Hillary Clinton','Ted Cruz')
##Winners['Illinois']=('Hillary Clinton','Donald Trump')
##Winners['Indiana']=('Bernie Sanders','Donald Trump')
##Winners['Kansas']=('Bernie Sanders','Ted Cruz')
##Winners['Kentucky']=('Hillary Clinton','Donald Trump')
##Winners['Louisiana']=('Hillary Clinton','Donald Trump')
##Winners['Massachusetts']=('Hillary Clinton','Donald Trump')
##Winners['Maine']=('Bernie Sanders','Ted Cruz')
##Winners['Maryland']=('Hillary Clinton','Donald Trump')
##Winners['Michigan']=('Bernie Sanders','Donald Trump')
##Winners['Minnesota']=('Bernie Sanders','Marco Rubio')
##Winners['Missouri']=('Hillary Clinton','Donald Trump')
##Winners['Mississippi']=('Hillary Clinton','Donald Trump')
##Winners['Montana']=('Bernie Sanders','Donald Trump')
##Winners['Nebraska']=('Bernie Sanders','Donald Trump')
##Winners['North Carolina']=('Hillary Clinton','Donald Trump')
##Winners['North Dakota']=('Bernie Sanders','NA')
##Winners['New Hampshire']=('Bernie Sanders','Donald Trump')
##Winners['New Jersey']=('Hillary Clinton','Donald Trump')
##Winners['New Mexico']=('Hillary Clinton','Donald Trump')
##Winners['Nevada']=('Hillary Clinton','Donald Trump')
##Winners['New York']=('Hillary Clinton','Donald Trump')
##Winners['Ohio']=('Hillary Clinton','John Kasich')
##Winners['Oklahoma']=('Bernie Sanders','Ted Cruz')
##Winners['Oregon']=('Bernie Sanders','Donald Trump')
##Winners['Pennsylvania']=('Hillary Clinton','Donald Trump')
##Winners['Rhode Island']=('Bernie Sanders','Donald Trump')
##Winners['South Carolina']=('Hillary Clinton','Donald Trump')
##Winners['South Dakota']=('Hillary Clinton','Donald Trump')
##Winners['Tennessee']=('Hillary Clinton','Donald Trump')
##Winners['Texas']=('Hillary Clinton','Ted Cruz')
##Winners['Utah']=('Bernie Sanders','Ted Cruz')
##Winners['Virginia']=('Hillary Clinton','Donald Trump')
##Winners['Vermont']=('Bernie Sanders','Donald Trump')
##Winners['Washington']=('Bernie Sanders','Donald Trump')
##Winners['Wisconsin']=('Bernie Sanders','Ted Cruz')
##Winners['West Virginia']=('Bernie Sanders','Donald Trump')
##Winners['Wyoming']=('Bernie Sanders','Ted Cruz')
##Winners['District of Columbia']=('Hillary Clinton','Marco Rubio')
##Winners['Puerto Rico']=('Hillary Clinton','Marco Rubio')
...
def adddata(pollHistory, pollWhite, pollBlack, kitchenHistory, kitchenWhite, kitchenBlack, dataname):
    ...
    while (i < totallen and (len(dataname["model"][i])>4)):
        ...
        curTime = mktime(datetime.strptime(dataname["model"][i]["forecastdate"],'%Y-%m-%d').timetuple())+43200  #add half a day
...
def LstIntoTuple(xlst, ylst):
    result = []
    for i in range(len(xlst)):
        result.append([xlst[i],ylst[i]])
    return result
...
def AllStateGain(pollHistory, kitchenHistory, PWHistory):
    ...
    for i in range(len(dataNameList538)):
        ...
        for candidate in pollHistory[i][0]:
            print candidate
            (curPollSpent, curPollReturn, curPollRisk, curPollTrades) = calculateGains(state, candidate, pollHistory, PWHistory)
            if curPollTrades == 0:
                curPollWeight = 0
            else:
            ...
            (curKitchenSpent, curKitchenReturn, curKitchenRisk, curKitchenTrades) = calculateGains(state, candidate, kitchenHistory, PWHistory)
            ...
            print "------------"
            print str(state)+" "+str(candidate)+" Poll investment: " + str((curPollSpent, curPollReturn, curPollRisk, curPollTrades))
            print str(state)+" "+str(candidate)+" Kitchen investment: " + str((curKitchenSpent, curKitchenReturn, curKitchenRisk, curKitchenTrades))
    print "$$$$$$$$$$$$$$$$$$$"
...
def getAllCandidates(state, pollHistory, kitchenHistory, PWHistory):
    candidateList = []
    stateR = str(state)+'_R'
    stateD = str(state)+'_D'
    if stateR in dataNameList538:
        i = dataNameList538.index(stateR)
        for candidate in pollHistory[i][0]:
            if candidate not in candidateList:
                candidateList.append(candidate)
    if stateR in dataNameListPW:
        i = dataNameListPW.index(stateR)
        for candidate in PWHistory[i][0]:
            if candidate not in candidateList:
                candidateList.append(candidate)
    if stateD in dataNameList538:
        i = dataNameList538.index(stateD)
        for candidate in pollHistory[i][0]:
            if candidate not in candidateList:
                candidateList.append(candidate)
    if stateD in dataNameListPW:
        i = dataNameListPW.index(stateD)
        for candidate in PWHistory[i][0]:
            if candidate not in candidateList:
                candidateList.append(candidate)
...
def main():
    ...
    pollFinal = windowAverage(50,2,pollWhite,pollBlack)
    kitchenFinal = windowAverage(50,2,kitchenWhite,kitchenBlack)

    (xpoll,ypoll,sig) = tupleIntoLst(pollFinal)
    (xkitchen,ykitchen,sig) = tupleIntoLst(kitchenFinal)
    yxdiffpoll = listSubtract(ypoll,xpoll)
    yxdiffkitchen = listSubtract(ykitchen,xkitchen)

    print "PPPPPPPPPPPPPPPPPPPPPOLL"
    print LstIntoTuple(xpoll, ypoll)

    print "PPPPPPPPPPPPPPPPPPPPPDDDDDDDDDDDDDIff"
    print LstIntoTuple(xpoll, yxdiffpoll)

    print "KKKKKKKKKKKKKKKKKKKKKKKKKKKItchen"
    print LstIntoTuple(xkitchen, ykitchen)

    print "KKKKKKKKKKKKKKKKKKKKKKKKKDiff"
    print LstIntoTuple(xkitchen, yxdiffkitchen)

    plt.plot(xpoll,listSubtract(xpoll,xpoll),'k-', label="zero")
    plt.plot(xpoll,yxdiffpoll, 'b-', label="Poll")
    plt.plot(xkitchen,yxdiffkitchen,'g-', label="Kitchen")
    plt.show()

    json_poll = json.dumps(pollFinal)
    with open('pollFinal.json','w') as f:
        json.dump(json_poll, f)

    json_kitchen = json.dumps(kitchenFinal)
    with open('kitchenFinal.json','w') as f:
        json.dump(json_kitchen, f)
...
def mainpw():
    ...
    pwFinal = windowAverage(50,2,pwWhite,pwBlack)
  
    (xpw,ypw,sig) = tupleIntoLst(pwFinal)
    yxdiffpw = listSubtract(ypw,xpw)
    

    print LstIntoTuple(xpw, ypw)

    print LstIntoTuple(xpw, yxdiffpw)


    plt.plot(xpw,listSubtract(xpw,xpw),'k-', label="zero")
    plt.plot(xpw,yxdiffpw, 'b-', label="PW")
    plt.show()
    

    json_pw = json.dumps(pwFinal)
    with open('pwFinal.json','w') as f:
        json.dump(json_pw, f)
...
def main4():
    ...
    stateAbbrev = 'SD_R'
    candidate = 'Trump'
    GetPlots(stateAbbrev, candidate, pollHistory, kitchenHistory, PWHistory)
    AllStateGain(pollHistory, kitchenHistory, PWHistory)
    print getAllCandidates('SD', pollHistory, kitchenHistory, PWHistory)
...
def main5():
    ...
    candidate = 'Clinton'
    GetPlots(stateAbbrev, candidate, pollHistory, kitchenHistory, PWHistory)
    print calculateGains(stateAbbrev, candidate, pollHistory, PWHistory)
    AllStateGain(pollHistory, kitchenHistory, PWHistory)
    #print getAllCandidates('CA', pollHistory, kitchenHistory, PWHistory)
